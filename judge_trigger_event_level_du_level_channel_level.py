...
for event_number,run_number in event_list:
    ...
    for du_id_n in range(du_id.shape[0]):
        ...
        for trig_time_m in FLT0_trig_time_X: trig_chnl_list.append([du_id[du_id_n], trig_time_m, 'X'])
        for trig_time_m in FLT0_trig_time_Y: trig_chnl_list.append([du_id[du_id_n], trig_time_m, 'Y'])
    ...
    arry_trig, arry_trig_du_list = discuss_coincidence(trig_chnl_list, any_du, t_window, used_channels)
